...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        var ensureColumns = new[]
        {
            ...
            @"ALTER TABLE ""LifeEventPosts"" ADD COLUMN IF NOT EXISTS ""ReleaseAt"" TIMESTAMP WITH TIME ZONE",
            @"ALTER TABLE ""LifeEventPosts"" ADD COLUMN IF NOT EXISTS ""ReleaseToUserId"" VARCHAR(450)",
            @"ALTER TABLE ""LifeEventPosts"" ADD COLUMN IF NOT EXISTS ""ReleaseToFamilyGroupId"" INTEGER",
            @"CREATE INDEX IF NOT EXISTS ""IX_LifeEventPosts_ReleaseAt"" ON ""LifeEventPosts"" (""ReleaseAt"")",
            ...
            @"ALTER TABLE ""LifeEventPosts"" ADD COLUMN IF NOT EXISTS ""BookBody"" TEXT"
        };
